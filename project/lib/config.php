...
$dbuser = "fjl4";//your ucid since we follow this pattern
$dbpass = "Darth_chompus69";//database password generated or chosen per respective steps
$dbdatabase = "fjl4";//your ucid since we follow this pattern
?>