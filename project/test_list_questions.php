...
if (isset($_POST["search"]) && !empty($query)) {
    $db = getDB();
    $stmt = $db->prepare("SELECT id,question, survey_id from Questions WHERE survey_id like :q LIMIT 10");
...
?>
<form method="POST">
    <input name="query" placeholder="Search by Survey ID" value="<?php safer_echo($query); ?>"/>
